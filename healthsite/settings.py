...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "dev-unsafe-fallback")
...
# Optional for production (collectstatic target)
...
LOGIN_URL = '/admin/login/'       # where unauthenticated users are sent
